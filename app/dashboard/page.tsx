  ...
  return (
    <DashboardLayout>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Overview of all cemeteries and burial records</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <a
            ...
            className="block bg-white rounded-lg shadow hover:shadow-lg transition-all p-6 border border-gray-200 hover:border-green-300"
          >
          ...
          <a
            href="/dashboard/cemeteries"
            className="block bg-white rounded-lg shadow hover:shadow-lg transition-all p-6 border border-gray-200 hover:border-emerald-300"
          >
            <div className="flex items-center mb-4">
          ...
          <a
            href="/dashboard/cemeteries"
            className="block bg-white rounded-lg shadow hover:shadow-lg transition-all p-6 border border-gray-200 hover:border-teal-300"
          >
            <div className="flex items-center mb-4">
            ...
            <p className="text-gray-600">AI-powered search for deceased persons and burials</p>
          </a>
        </div>
    </DashboardLayout>
  );
